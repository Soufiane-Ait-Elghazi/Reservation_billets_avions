...
public class ModifierMonCompte extends JFrame {
	   
	  static int  id=0;
	  
	   String nom ,prenom;
	   String CIN , pasp,pass,npass,lgn ;
	   Date dn;
	  public static int getId() {
		return id;
	}

	public static void setId(int idl) {
		id = idl;
	}
	...
	public static String login;
	    ...
	    private void initComponents() {
	        ...
	        jLabel1.setFont(new Font("Calibri Light", Font.BOLD, 36)); // NOI18N
	        jLabel1.setForeground(new Color(255, 255, 153));
	        jLabel1.setText("Modifier Mon Compte");
	        jPanel1.add(jLabel1);
	        jLabel1.setBounds(90, 10, 350, 44);
	        ...
	        jLabel3.setFont(new Font("Calibri Light", Font.BOLD, 13)); // NOI18N
	        jLabel3.setForeground(Color.WHITE);
	        jLabel3.setText("Num de passeport :");
	        jPanel1.add(jLabel3);
	        jLabel3.setBounds(40, 340, 120, 20);

	        jLabel4.setFont(new Font("Calibri Light", Font.BOLD, 13)); // NOI18N
	        jLabel4.setForeground(Color.WHITE);
	        jLabel4.setText("Nom :");
	        jPanel1.add(jLabel4);
	        jLabel4.setBounds(40, 110, 120, 15);

	        jLabel6.setFont(new Font("Calibri Light", Font.BOLD, 13)); // NOI18N
	        jLabel6.setForeground(Color.WHITE);
	        jLabel6.setText("Prenom :");
	        jPanel1.add(jLabel6);
	        jLabel6.setBounds(40, 160, 120, 15);

	        jLabel7.setFont(new Font("Calibri Light", Font.BOLD, 13)); // NOI18N
	        jLabel7.setForeground(Color.WHITE);
	        jLabel7.setText("Nouveau Mot de passe :");
	        jPanel1.add(jLabel7);
	        jLabel7.setBounds(390, 250, 140, 20);

	        jLabel8.setFont(new Font("Calibri Light", Font.BOLD, 13)); // NOI18N
	        jLabel8.setForeground(Color.WHITE);
	        jLabel8.setText("C.I.N :");
	        jPanel1.add(jLabel8);
	        jLabel8.setBounds(40, 270, 120, 20);

	        jLabel9.setFont(new Font("Calibri Light", Font.BOLD, 13)); // NOI18N
	        jLabel9.setForeground(Color.WHITE);
	        jLabel9.setText("Date naissance :");
	        jPanel1.add(jLabel9);
	        jLabel9.setBounds(40, 200, 120, 20);

	        jLabel10.setFont(new Font("Calibri Light", Font.BOLD, 13)); // NOI18N
	        jLabel10.setForeground(Color.WHITE);
	        jLabel10.setText("Login  :");
	        jPanel1.add(jLabel10);
	        jLabel10.setBounds(390, 120, 120, 20);

	        jLabel11.setFont(new Font("Calibri Light", Font.BOLD, 13)); // NOI18N
	        jLabel11.setForeground(Color.WHITE);
	        jLabel11.setText("Auncien Mot de passe :");
	        jPanel1.add(jLabel11);
	        jLabel11.setBounds(390, 180, 140, 20);
	        ...
	        jButton1.addActionListener(new java.awt.event.ActionListener() {
	            public void actionPerformed(java.awt.event.ActionEvent evt) {
		   	    ...
		   	    // jLabel12.setText(id+"");
	    	  	  if(nom.equals("")||prenom.equals("")||CIN.equals("")||lgn.equals("")||pass.equals("")||npass.equals("")||pasp.equals(""))
	    	  		//jLabel12.setText("test");
	    	  		JOptionPane.showMessageDialog(null,"Remplir les champs ","Remplissage",JOptionPane.OK_OPTION);
				else
					try {
						if(Client.testAncMotDePasse(id,pass)==1) {
							try {
								Client.modifierClient(id,new Client(nom, prenom,t, CIN,pasp, lgn,npass));
							  ...
							  jPasswordField1.setText("");
							  jPasswordField2.setText("");
							 JOptionPane.showMessageDialog(null,"Auncien Mot De Passe Incorect ","Vérification Mot De Passe",JOptionPane.OK_OPTION); 
						   }
	        ...
	        jLabel5.setIcon(new ImageIcon(ModifierMonCompte.class.getResource("/Pr\u00E9sentation/FenetrePrincipale.jpg"))); // NOI18N
	        jPanel1.add(jLabel5);
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(ModifierMonCompte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                new ModifierMonCompte().setVisible(true);
	            }
	        });
	    }
