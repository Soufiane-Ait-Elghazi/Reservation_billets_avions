...
public class DeleteCategorie extends JFrame {
	...
	int idSup;
	  public static String login;
	    ...
	    private void initComponents() {
	        ...
	        jLabel1.setText(" Supprimer Catégorie");
	        jLabel1.setToolTipText("");

	        jLabel2.setFont(new java.awt.Font("Candara", 1, 12)); // NOI18N
	        jLabel2.setText("Identificateur de catégorie à supprimer : ");
	            	...
	            	//Supprimer Cat
	            	 if(jTextField1.getText().equals(""))
	         	        ...
	         	        idSup=Integer.parseInt(jTextField1.getText());
	         	         try {
							Métier.Admin.supprimerCategorie(idSup);
						} catch (Exception e) {
							// TODO Auto-generated catch block
							e.printStackTrace();
						}
	         	        jLabel4.setForeground(new java.awt.Color(0, 102, 0));
	         	         jLabel4.setText("La supprission effectué.");  
	         	        }
	        ...
	        jLabel4.setFont(new Font("Calibri Light", Font.BOLD, 19)); // NOI18N
	        ...
	        jPanel1Layout.setHorizontalGroup(
	        	jPanel1Layout.createParallelGroup(Alignment.TRAILING)
	        		...
	        		.addGroup(jPanel1Layout.createSequentialGroup()
	        			...
	        			.addComponent(jLabel4, GroupLayout.PREFERRED_SIZE, 297, GroupLayout.PREFERRED_SIZE)
	        			.addContainerGap())
	        );
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(DeleteCategorie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                new DeleteCategorie().setVisible(true);
	            }
	        });
	    }
