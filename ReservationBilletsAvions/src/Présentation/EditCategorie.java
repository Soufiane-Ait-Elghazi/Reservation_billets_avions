...
public class EditCategorie extends JFrame {
	
	  int idRetourne;
	  double resmiseRetourne;
	  String nomRetourne;
	    ...
	    private void initComponents() {
	        ...
	        jLabel2.setText("Identificateur de catégoie à modifier:");
	        ...
	        jLabel3.setText("Nouveau nom catégorie:");

	        jLabel5.setText("Nouveau remise :");
	        ...
	        jButton1.addActionListener(new java.awt.event.ActionListener() {
	    	    ...
	    	    JOptionPane.showMessageDialog(null, "Attention un ou plusieurs champs sont vides !!","Champs Vide",JOptionPane.OK_OPTION);
	    	        ...
	    	        resmiseRetourne = Double.parseDouble(jTextField5.getText()); 
	    	        try {
						Métier.Admin.modifierCategorie(idRetourne,nomRetourne, resmiseRetourne);
						JOptionPane.showMessageDialog(null, "Modification effectuée","Modification Catégorie",JOptionPane.INFORMATION_MESSAGE);
					} catch (Exception e) {
	    ...
	    public static void main(String args[]) {
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(EditCategorie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        ...
	        java.awt.EventQueue.invokeLater(new Runnable() {
	            public void run() {
	                new EditCategorie().setVisible(true);
	            }
	        });
	    }
