    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		try {
					C = Client.authentification(A, B);
					if(C.charAt(0)=='B') {
						EspaceClient E = new EspaceClient();
						setVisible(false);
						E.setVisible(true);
						Reserver.setId(Client.returnIdClient(A));
						MesReservations.setId1(Client.returnIdClient(A));
						TableBillets.setId2(Client.returnIdClient(A));
						ModifierMonCompte.setId(Client.returnIdClient(A));
					}
					jLabel5.setText(C);
				} catch (Exception e1) {
        ...
        jLabel5.setText("");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(30, 370, 280, 30);
        ...
        jButton1.setBounds(200, 260, 200, 30);
        ...
        jLabel1.setIcon(new ImageIcon(LoginClient.class.getResource("/Pr\u00E9sentation/FenetrePrincipale.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
